...
_RAW_CB_TYPE = ct.CFUNCTYPE(ct.py_object, ct.py_object, ct.c_void_p, ct.c_int)
_LOST_CB_TYPE = ct.CFUNCTYPE(ct.py_object, ct.py_object, ct.c_ulonglong)
...
lib.bpf_open_perf_buffer_with_flags.restype = ct.c_void_p
lib.bpf_open_perf_buffer_with_flags.argtypes = [_RAW_CB_TYPE, _LOST_CB_TYPE, ct.py_object, ct.c_int, ct.c_int, ct.c_int, ct.c_int]
